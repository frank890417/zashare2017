let data = {
  ...
  member: {
    ...
    form: {
      ...
      register: {
        ...
        name: "Name",
        name_explain:
          'If you had "ZASHARE" student card, please register with your real name to use student features.',
        jobcata: "Current industry",
        jobcatas: [
          { value: "政府機關、公部門", label: "Government, public sector" },
          {
            value: "非營利組織相關",
            label: "NGO, NPO, Religious Organizations"
          },
          {
            value: "教育業",
            label: "Academic institutions, Education and Related Clerks"
          },
          { value: "學生", label: "Student" },
          { value: "自由接案", label: "Freelancer" },
          {
            value: "大眾傳播、出版相關",
            label: "Marketing Professional, Publishing Activities"
          },
          ...
          {
            value: "流行與時尚文化相關",
            label: "Fashion, Hairdressing and Other Beauty Treatment"
          },
          {
            value: "旅遊、休閒、運動產業 ",
            label:
              " Tourism, Sports Activities and Amusement and Recreation Activities"
          },
          {
            value: "金融投顧、保險相關",
            label: "Financial Leasing and Insurance"
          },
          ...
          {
            value: "農、林、漁、牧業",
            label: "Agriculture, Forestry, Fishing and Animal Husbandry"
          },
          { value: "礦業土石、水電能源", label: "Mining and Quarrying" },
          {
            value: "建築營造、不動產相關",
            label:
              "Building Frame, Real Estate Activities and Related Trades Work"
          },
          {
            value: "醫療照護、環境衛生",
            label: "Health service, Social welfare, Environment welfare"
          },
          { value: "批發零售", label: "Wholesale and Retail Trade" },
          {
            value: "電子科技、資訊、軟體、半導體",
            label: "Software Developers and Programmers"
          },
    ...
    password_reset_success:
      "Reset password successfully! Please close and login.",
  ...
  menu: {
    ...
    register_mobile_warning:
      "Please use computer to complete the registration process.",
...
much more powerful.”`
    ...
    themes: ["Imagine", "Explore", "Diversify"],
    ...
    expos: [
      {
        ...
        features: [
          "Reserved all exhibition spaces in Huashan 1914 Creative Park and set a record-breaking visitor number of fifty thousand people",
      ...
      },
      {
        ...
        subtitle:
          "The attitude of the year promotes <br>“Learn to be, not taught to fit.”",
        features: [
      ...
      },
      {
        ...
        subtitle:
          "The attitude of the year promotes <br>“Behaving yourself by being yourself”",
        features: [
  ...
  form: {
    ...
    confirm_dialog_title:
      "Are you sure to submit? You will not be able to edit the data after confirmation.",
    ...
    data_not_complete:
      "Data not required or wrong format, please check the form again."
  },
  regist_expo: {
    title: "Exhibition Application Form",
    sub_title:
      "To make sure of successful registration, refer to the regulations, schedule and process in the exhibition manual.",

    confirm_title: "It's almost completed!",
    confirm_text:
      "Please reconfirm your application, and press the “Submit” button.<br>We will send the application confirmed e-mail within three days. <br>If you do not receive the reply within three days, don’t hesitate to reach out to the organizer.<br><br>I confirmed that the application has been corrected and completed. It will not be modifiable after submit.",
    complete_text:
      'Thank you for creating the better education with us.<br>The result will be announced at 07/10（Tue).<br>It will be reveal on the "ZA SHARE" official website.',
    ...
    sections: [
        ...
        questions: [
          {
            ...
            options: [
              {
                label: "Basic booth(width 1m x depth 1m x height 2.5m)",
                value: "基礎單位 (1m*1m 限高2.5m)"
              },
              {
                label: "Standard booth(width 3m x depth 2m x height 2.5m)",
                value: "標準單位 (2m*3m 限高2.5m)"
              },
              {
                label: "Advanced booth(width 6m x depth 2m x height 2.5m)",
                value: "進階單位 (2m*6m 限高2.5m)"
              }
            ]
          },
          {
            title:
              "2. Exhibitor category (The organizer reserves the ultimate right to assign the exhibitor to specific categories)",
            prop: "theme",
            options: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                label: "2015 Naughty Education Fest",
                value: "2015不太乖教育節"
              },
          ...
          {
            title:
              "5. The country/city you currently lived in or your group located at",
...

      {
        ...
        questions: [
          ...
          {
            title:
              "3. Your current target audience (choose two most relevant groups)",
            type: "select",
          ...
          {
            title:
              "4. Target audience you wish to approach at Za Share (choose two most desired groups)",
            type: "select",
            prop: "want_audience",
            settings: {
              multiple: true,
          ...
          },
          {
            ...
            options: [
              {
                label:
                  "Yes (include your products and prices in the application proposal presentation)",
                value: 1
              },
              { label: "No", value: 0 }
            ]
          ...
          {
            title:
              "6. Talk about your exhibition plan in a presentation with no more than 20 slides. (The organizer will select Za Star Award winners based on the document)",
            type: "file",
            prop: "file_proposal",
          ...
          {
            title:
              "7. Why you want to participate in the exhibition? (50 words)",
            type: "textarea",
            prop: "attend_reason",
            settings: {
              maxlength: 100
      ...
      },
      {
        ...
        questions: [
          {
            title:
              "1. Primary contact person Name(designated individual preferred)",
        ...
        questions: [
          {
            ...
            options: [
              ...
              {
                label: "Innovative teaching plan sharing",
                value: "創新教案分享與教學"
              },
              {
                label: "Small - scale panel discussion",
                value: "小型分享座談"
              },
          ...
          },
          {
            ...
            prop: "class_audience",
            explain:
              "Any eligibility requirements such as status or age? For family only or for a specific age group, please write down your requirements",
            required: false,
            settings: {
          ...
          },
          {
            ...
            type: "select",
            explain:
              "Select multiple sessions for possible arrangement. The organizer has the right for final review and decision-making, and the exhibitor may not oppose to the decision made.",
            prop: "class_time",
            settings: {
              multiple: true
            },
            options: [
              {
                label: "10 / 5(Fri) 13: 00 - 14: 30",
                value: "10/5 (五) 13:00-14:30"
              },
              {
                label: "10 / 5(Fri) 15: 00 - 16: 30",
                value: "10/5 (五) 15:00-16:30"
              },
              {
                label: "10 / 5(Fri) 17: 00 - 18: 30",
                value: "10/5 (五) 17:00-18:30"
              },
              {
                label: "10 / 6(Sat) 10: 00 - 11: 30",
                value: "10/6 (六) 10:00-11:30"
              },
              {
                label: "10 / 6(Sat) 13: 00 - 14: 30",
                value: "10/6 (六) 13:00-14:30"
              },
              {
                label: "10 / 6(Sat) 15: 00 - 16: 30",
                value: "10/6 (六) 15:00-16:30"
              },
              {
                label: "10 / 6(Sat) 17: 00 - 18: 30",
                value: "10/6 (六) 17:00-18:30"
              },
              {
                label: "10 / 7(Sun) 10: 00 - 11: 30",
                value: "10/7 (日) 10:00-11:30"
              },
              {
                label: "10 / 7(Sun) 13: 00 - 14: 30",
                value: "10/7 (日) 13:00-14:30"
              },
              {
                label: "10 / 7(Sun) 15: 00 - 16: 30",
                value: "10/7 (日) 15:00-16:30"
              },
              {
                label: "10 / 7(Sun) 17: 00 - 18: 30",
                value: "10/7 (日) 17:00-18:30"
              }
            ]
          },
          {
            title:
              "5. Talk about your activity proposal with no more than 10 pages. (The organizer will select Za Workshop winners based on the document)",
            type: "file",
            prop: "class_proposal",
    ...
    sections: [
      {
        ...
        questions: [
          {
            title:
              "1.	If nominated, do you agree to have the organizer design for you?",
            type: "select",
            prop: "agree_plan",
            options: [
              {
                label:
                  "Yes, I will exhibit in Za Concept Exhibition. (Za Share will specially curate an exhibition for the nominees)",
                value: 1
              },
              {
                label:
                  "No, I wish to stay in ZA EXPO. (Exhibitors design their own booths)",
                value: 0
              }
            ]
          },
      ...
      },
      {
        ...
        questions: [
          ...
          {
            title:
              "3.	Describe the difficulties you are encountering (50-80 words)",
            type: "textarea",
          ...
          {
            title:
              "4.	Describe the education issues you wish to address (50-80 words)",
            type: "textarea",
          ...
          {
            title:
              "5.	What impact will your team/products bring to society?  (50-80 words)",
            type: "textarea",
            prop: "startup_power",
            settings: {
              maxlength: 300
          ...
          {
            title:
              "6. Talk about your pitch proposal in a presentation with no more than 20 slides. (The organizer will select Zac. nominees based on the document)<br><br>File size: 20MB / PDF format only",
            type: "file",
