...
.page.member-regist-expo.text-left
  .container
    .col-sm-12
      ...
      .row
        .col-sm-12
      p 雜學校設法創造一個能提供實質資源的公開平台，透過Zac.徵選，邀請通過初選之10組入圍團隊（每一參與者均收20000元/展位）將移展至「雜學校概念館 」，由雜學校團隊量身訂製策展規劃，不只提供行銷與曝光的舞台，並讓其他參展團隊、記者媒體、貴賓等也有一個很棒的觀摩機會！（詳細參與辦法及相關評選內容請見徵展手冊 P.XX）
