            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                      ...
                      <table class='table table-hover' id=posttable>
                        ...
                        @foreach ($posts as $id => $post)
                          <tr class=''> 
                            ...
                            <td> {{ $post->name_cht }} </td>
                            @if (!Auth::guest())
                              <td> <a href="{!! URL::to('post/').'/'.$post->id.'/edit' !!}" target=''>{{ $post->title }}</a> </td>
                            @else
                              <td> {{ $post->title }} </td>
                            @endif
                            @if (!Auth::guest())
                             ...
                             <!--  <td> 
                                  <a class='btn btn-default btn-md' href="{!! URL::to('post/'.$post->id) !!}" >瀏覽</a>
                              </td> -->
                              <td>
                                  <a class='btn btn-default btn-md' href="{!! URL::to('post/'.$post->id.'/edit') !!}" >編輯</a>
                              </td>
                              <td>
                    ...
                    @else
                      ...
                      <a class='btn btn-default' href='{!! URL::to('post/create') !!}'>新增文章</a>
                    @endif
