            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                      ...
                      <table class='table table-hover' id=posttable>
                        ...
                        @foreach ($companies as $id => $company)
                          <tr class=''> 
                            ...
                            @if (!Auth::guest())
                             <!--  <td> 
                                  <a class='btn btn-default btn-md' href="{!! URL::to('company/'.$company->id) !!}" >瀏覽</a>
                              </td> -->
                              <td>
                                  <a class='btn btn-default btn-md' href="{!! URL::to('company/'.$company->id.'/edit') !!}" >編輯</a>
                              </td>
                            <!--   <td>
                    ...
                    @else
                      ...
                      <a class='btn btn-default' href='{!! URL::to('company/create') !!}'>新增文章</a>
                    @endif
